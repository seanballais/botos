...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            # This likely means that batch 0 has already been created, so no
            # need to create another one of the same year.
            pass

        try:
            section = Section.objects.create(section_name='Superusers')
        except IntegrityError:
            # This likely means that section Superusers has already been
            # created, so no need to create another one of the same name..
            pass
